...
class _AndroidLarge14State extends State<AndroidLarge14> {
  ...
  Future<void> unMatchStudent(int id) async {
    final url =
        Uri.parse('http://192.168.11.138:8080/api/students/$id/unmatch');
    try {
  ...
  Future<void> reportStudent(int reportedPersonId, String context) async {
    final url = Uri.parse('http://192.168.11.138:8080/api/students/report');
    final reportDto =
  ...
  Future<void> blockStudent(int blockedPersonId) async {
    final url = Uri.parse('http://192.168.11.138:8080/api/students/block');
